    ...
    <div className="p-6 space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-500 mt-1">Track all activities in your organization</p>
        </div>
        ...
        <CardContent>
          {loading ? (
            ...
            <div className="text-center py-12 text-gray-500">
              ...
              <p className="text-sm mt-2">Activity will appear here as users perform actions</p>
            </div>
          ) : (
