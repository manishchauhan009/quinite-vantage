...
export default function OnboardingPage() {
  ...
  const checkStatus = async () => {
    ...
    // Verify user is Org Super Admin
    if (userData.user.profile?.role?.name !== 'Client Super Admin') {
      setError('Only Organization Super Admin can complete onboarding')
      return
    }
